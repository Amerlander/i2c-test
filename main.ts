...
function Speicherkarte () {
    Dateiname = "" + rtcpcf85063tp.getyyMMddHHmmss(0, 8) + ".LOG"
    ...
    qwiicopenlog.writeFile(qwiicopenlog.eADDR.LOG_Qwiic, Dateiname, "" + Dateiname + ";" + rtcpcf85063tp.getDate(rtcpcf85063tp.ePart.mit, rtcpcf85063tp.ePart.mit) + ";" + rtcpcf85063tp.getTime(rtcpcf85063tp.ePart.mit) + ";" + bit.formatNumber(dipswitch.getBIN(), bit.eLength.BIN_11111111) + ";" + input.temperature() + "°C;x:" + DrehungX + ";y:" + DrehungY + ";A:" + input.buttonIsPressed(Button.A) + ";B:" + input.buttonIsPressed(Button.B), qwiicopenlog.eCRLF.CRLF)
}
